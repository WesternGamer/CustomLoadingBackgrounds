...
namespace CustomScreenBackgrounds.GUI
{
    ...
    public class MyPluginConfigDialog : MyGuiScreenBase
    {
        ...
        private void CreateControls()
        {
            ...
            CreateCheckbox(out CustomMainMenuOverlayLabel, out CustomMainMenuOverlayCheckbox, config.CustomMainMenuOverlay, value => config.CustomMainMenuOverlay = value, "Custom Main Menu Overlay", "This overlay shows up in the main menu when enabled and when textures is in the CustomOverlays\\MainMenu folder.");
            CreateCheckbox(out CustomLoadingMenuOverlayLabel, out CustomLoadingMenuOverlayCheckbox, config.CustomLoadingMenuOverlay, value => config.CustomLoadingMenuOverlay = value, "Custom Loading Menu Overlay", "This overlay shows up in the loading menu when enabled and when textures is in the CustomOverlays\\LoadingMenu folder.");
